...
Просто напишите карту уровня в текстовом файле, используя символы, поддерживаемые игрой. Полный список символов можно найти на [GitHub странице](https://github.com/SIBDuck/JumpOverlord/).
